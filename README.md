...
`openetR` is a tidy R client for the [OpenET API](https://openet.gitbook.io/docs/).
It supports point and polygon raster time-series queries plus raster metadata.

## Installation

This package is currently under development. Install it from a local checkout
with `pak::pak(".")` or `devtools::install()`.
